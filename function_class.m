classdef GeometricObjectProcessor
    ...
    methods
        ...
        function obj = sample_surface(obj, num_samples)
            ...
            triangulated_faces = obj.TriangulatedFaces;
             ...
             obj.SampledPoints = sampled_points; % Example assignment
        end
        ...
        function D2_distribution_plot(obj, Sampled_points)
            if nargin < 2 % Use obj.SampledPoints if no argument is provided
                Sampled_points = obj.SampledPoints;
            end
